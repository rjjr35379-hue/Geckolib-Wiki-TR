...
- [Manually position/hide bones](/docs/concepts/geobones/bone-updaters.mdx)
- [Retrieve the bone's position in the world](/docs/concepts/geobones/bone-position-listeners.mdx)
- [Set DataTicket values](/docs/concepts/rendering/renderstates.mdx)