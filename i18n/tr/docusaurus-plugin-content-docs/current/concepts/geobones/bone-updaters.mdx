...
## Overview
Because of the changes Mojang has made to rendering in Minecraft (see: [Bone Snapshots](bone-snapshots.mdx#overview)),
...
1. If you are modifying them inside a `GeoRenderer`, you override and use `adjustModelBonesForRender`. See [here](bone-snapshots#usage)
...
See the [BoneSnapshots](bone-snapshots.mdx#usage) page for more information on using them.
