...
#### Examples
<Collapsible title="Example DefaultedItemGeoModel Usage">
    ```java
...
<Collapsible title="Example DefaultedEntityGeoModel Usage">
    ```java
...
<Collapsible title="Example DefaultedGeoModel Usage">
    ```java
