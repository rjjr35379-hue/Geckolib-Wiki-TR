...
Once you've made your item class and registered your item, you can now create the renderer and register it.
...
<Tabs groupId="renderer" queryString="renderer">
    <TabItem value="simple" label="Simple">
        ...
        `GeoItemRenderer` when registering your renderer.
        ...
        <Tabs groupId="modloader" queryString="modloader">
            ...
            <TabItem value="forge" label="Forge">
                ```java
                // Registering the renderer
                () -> new GeoItemRenderer<>(ItemRegistry.EXAMPLE_ITEM.get());
                ```
            </TabItem>
