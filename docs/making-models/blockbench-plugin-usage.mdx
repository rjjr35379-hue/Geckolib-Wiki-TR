...
This will create a new GeckoLib armor model template with the correct bone positions and names.<br/>
From there, ensure you **__ONLY__** add bones and cubes into the `armor` prefixed bones.
...
<Collapsible title="Available Properties – Click to expand">
