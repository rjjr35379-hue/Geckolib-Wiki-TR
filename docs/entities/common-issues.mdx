...
import ErrorMessage from "@site/src/components/error-message";
...
Then you forgot to [register your entity renderer](./the-entity-renderer.mdx#registering-the-renderer).
