...
This `RenderPassInfo` accepts [Bone Updaters](bone-updaters.mdx), which allow for GeckoLib to perform an operation on bones
when run.
...
## More information
See the [Bone Snapshots](/concepts/geobones/bone-snapshots.mdx) page for more information.